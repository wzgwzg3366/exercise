...
class IPHelper
{
     ...
     * @return string
     */
    public static function fuzzyIpV4($ip)
    {
        $ipArray = explode('.', $ip);
     ...
     * @return string
     */
    public static function fuzzyIpv4End($ip)
    {
        $ipArray = explode('.', $ip);
     ...
     * @return string
     */
    public static function startIpv4($ip)
    {
        $ipArray = explode('.', $ip);
     ...
     * @return string
     */
    public static function endIpv4($ip)
    {
        $ipArray = explode('.', $ip);
     ...
     * @return float|int
     */
    public static function startIpv4Long($ip)
    {
     ...
     * @return float|int
     */
    public static function endIpv4Long($ip)
    {
     ...
     * @return array
     */
    public static function segmentForIpv4($ip)
    {
     ...
     * @return bool
     */
    public static function isPrivateForIpV4($ip)
    {
